let R, G, V, U, bn, au, w = window,
  ...
  __ = fA ? 1400 : 1e3,
  di = "Dismiss";
_u = ((t, s, i) => s < t ? t : s > i ? i : s), _f = ((t, s, i) => s >= t && s <= i), C = ((t, s) => random() * (s - t) + t), _a = (t => t[~~(random() * t.length)]), bu = ((t, s, i, h) => sqrt(pow(t - i, 2) + pow(s - h, 2))), F = ((t, s) => bu(t
  .x, t.y, s.x, s.y)), bc = (t => t < 0 ? -1 : t > 0 ? 1 : 0), cZ = ((t, s) => ((t %= 2 * s) > s && (t -= 2 * s), t < -s && (t += 2 * s), t)), aP = (t => cZ(t, PI)), _Q = ((t, s) => atan2(s.y - t.y, s.x - t.x));
let m = Math;
...
class eG extends cw {
  constructor(t) {
    super(), this.$ = t._f(100, 200), this._B = el(t), this._E = _E(this._B), this.cJ = eH(aU(2 * this.$, 2 * this.$, () => 0), 100, "rgba(255,0,0,0.3)", "rgba(255,0,0,0)"), this._z = createRadialGradient(0, 0, 0, 0, 0, this.$), this._z
      .addColorStop(0, "#fff"), this._z.addColorStop(.3, "#ff0"), this._z.addColorStop(1, "#f80"), this.cH = (() => "#ff0")
  }
  _e() {
...
class gf extends cw {
  constructor(t, s, i) {
    super(), this.L = bW(i), this.$ = ~~this.L._f(100, 200), this.ai = 4 * this.$, this.B = new cu(this, this.L._f(0, .7)), this._B = el(this.L), this._E = _E(this._B), this.cL = this.L._f(PI / 8, PI / 12), this.cH = (() => "#fff"), this._N =
      t, this.bB = this.L._f(0, M), this._R = s, this.eb = this.L.ge() < .3, this.aq = [], this.A = 0, this.ea();
  ...
  _e() {
    V._x(this._N, this._R + 2 * this.$) && (R.lineWidth = 10, R.strokeStyle = "rgba(255,255,255,0.1)", beginPath(), arc(this._N.x, this._N.y, this._R, 0, M), stroke(), V._x(this, this.$ + 50) && (R.strokeStyle = "#fff", R.lineWidth = 60, this
      .eb && N(() => {
...
class gv extends dD {
  ...
  W(t) {
    ...
    let s = this.aX();
    s && this._q(s, .15 * t), G.S - this.dt > 5 && (this.aj += .05 * t), this.aj = min(this._k, this.aj), (this.dj -= t) < 0 && this.fB(), super.W(t), this.af ? this.a$ || (this.a$ = a$(), this.a$.loop = 1) : this.a$ && (this.a$.pause(), this
      .a$ = 0)
  }
  fB() {
...
function gD() {
  ...
  this.bO = new gA, this.dC = function() {
    var t = this.bO;
    h = 100 / (t.f * t.f + .001), e = 100 / (t.g * t.g + .001), a = 1 - t.h * t.h * t.h * .01, r = -t.i * t.i * t.i * 1e-6, t.a || (o = .5 - t.n / 2, c = 5e-5 * -t.o), l = 1 + t.l * t.l * (t.l > 0 ? -.9 : 10), _ = 0, n = 1 == t.m ? 0 : (1 - t
      .m) * (1 - t.m) * 2e4 + 32
  }, this.gH = function() {
    this.dC();
    var h = this.bO;
    ...
    for (it = 0; it < d; it++) {
      if (H) return it;
      if (R && ++j >= R && (j = 0, this.dC()), n && ++_ >= n && (n = 0, h *= l), (h *= a += r) > e && (h = e, U > 0 && (H = 1)), M = h, P > 0 && (M *= 1 + sin(z += D) * P), (M |= 0) < 8 && (M = 8), A || ((o += c) < 0 ? o = 0 : o > .5 && (o =
          .5)), ++K > T) switch (K = 0, ++q) {
        case 1:
          T = s;
          break;
...
class hw {
  constructor() {
    G = this, U = new gx, V = new hs, G.eR(), G.S = 0, G.bZ = _E("everyone's"), G.c$ = _E("sky"), G.cm = _E("press enter to send a ship"), G.eU = G.cg = 50, G.cf = G.eY = 100, G.ci = 0, G.dl = 1, G.eZ = 0, G.cr = 1, G.hy = 1, G.ff = 1, G.ct =
      "#fff"
  }
  bQ(t) {
  ...
  W(t) {
    G.S += t, G.bP && ((G.df -= t) <= 0 && G.hC(), U.W(t), G.aJ.c_(1, t)), ca.slice().forEach(s => s.W(t)), w.Z[13] && G.bg(), U._e(), N(() => {
      ...
      let a = U.D._F();
      a && a != G._F && (G.hN = G.S + 3, G._F = a, hm()), a || (G._F = 0), G._F && G.S < G.hN && (I("rgba(255,0,0,0.5)"), fr(0, 200, 1e3, 125), R.font = "36pt " + au, R.textBaseline = "middle", R.textAlign = "center", I("#fff"), fillText(
        "/!\\ WARNING /!\\", 500, 250), R.font = "18pt " + au, fillText(G._F, 500, 300), G._Z = 0), R.strokeStyle = "#fff", R.lineCap = "round", G._Z && G.hO && N(() => {
        R.lineWidth = 4;
        let t = 20 * G._Z.width;
  ...
  fK() {
    ...
    t = i + h < 10 ? "you were barely noticed" : abs(i - h) < 5 ? "little has changed" : i > h ? "you brought war" : "you brought peace", G.bZ = _E("game over"), G.c$ = _E(t), G.cm = _E("press enter to send another ship"), G.cg = 25, G.eY = 50,
      G.hR = 6, G.dl = G.bP = 0, G.S = 0, _g(G, "dW", -__, 0, .3, 0, 0, () => G.eR()), setTimeout(() => {
